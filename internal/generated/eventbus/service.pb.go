...
const file_proto_service_proto_rawDesc = "" +
	"\n" +
	"\x13proto/service.proto\x12\beventbus\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\x06PubSub\x12:\n" +
	"\tSubscribe\x12\x1a.eventbus.SubscribeRequest\x1a\x0f.eventbus.Event0\x01\x12;\n" +
	"\aPublish\x12\x18.eventbus.PublishRequest\x1a\x16.google.protobuf.EmptyB&Z$internal/generated/eventbus;eventbusb\x06proto3"
...
var file_proto_service_proto_goTypes = []any{
	(*SubscribeRequest)(nil), // 0: eventbus.SubscribeRequest
	(*PublishRequest)(nil),   // 1: eventbus.PublishRequest
	(*Event)(nil),            // 2: eventbus.Event
	(*emptypb.Empty)(nil),    // 3: google.protobuf.Empty
}
var file_proto_service_proto_depIdxs = []int32{
	0, // 0: eventbus.PubSub.Subscribe:input_type -> eventbus.SubscribeRequest
	1, // 1: eventbus.PubSub.Publish:input_type -> eventbus.PublishRequest
	2, // 2: eventbus.PubSub.Subscribe:output_type -> eventbus.Event
	3, // 3: eventbus.PubSub.Publish:output_type -> google.protobuf.Empty
